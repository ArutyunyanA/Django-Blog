...
urlpatterns = [
    ...
    path('event/comments/<int:comment_id>/edit/', views.event_edit_comment, name='event_edit_comment'),
    path('event/comments/<int:comment_id>/delete/', views.event_delete_comment, name='event_delete_comment'),
]