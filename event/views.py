...
def event_edit_comment(request, comment_id):
    ...
    return render(request, 'event/comment/edit_comment.html', {'form': form, 'comment': comment})
...
def event_delete_comment(request, comment_id):
    ...
    return render(request, 'event/comment/delete_comment.html', {'comment': comment})
