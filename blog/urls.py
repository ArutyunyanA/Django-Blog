...
urlpatterns =[
    ...
    path('post/comments/<int:post_id>/comment/', views.post_comment, name='post_comment'),
    path('post/comments/<int:comment_id>/edit/', views.edit_comment, name='edit_comment'),
    path('post/comments/<int:comment_id>/delete/', views.delete_comment, name='delete_comment'),
