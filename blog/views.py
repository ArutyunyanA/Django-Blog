...
def post_share(request, post_id):
    ...
    # Форма была передана на обработку
        ...
        # Поля формы успешно прошли валидацию
            ...
            send_mail(subject, message, 'arutyunyan_av@icloud.com', [cd['to']])
            sent = True
...
# нужно проверить правильно ли все написано
@csrf_protect
@login_required
...
def edit_comment(request, comment_id):
    ...
    return render(request, 'blog/post/comment/edit_comment.html', {'form': form, 'comment': comment})
...
def delete_comment(request, comment_id):
    ...
    return render(request, 'blog/post/comment/delete_comment.html', {'comment': comment})
